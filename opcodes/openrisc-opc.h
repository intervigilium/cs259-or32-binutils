...
typedef enum cgen_insn_type {
 ...
 , OPENRISC_INSN_L_SFNEI, OPENRISC_INSN_L_ADDX, OPENRISC_INSN_L_SUBX, OPENRISC_INSN_L_MULX,
 , OPENRISC_INSN_L_DIVX, OPENRISC_INSN_L_ADDIX, OPENRISC_INSN_L_SUBIX, OPENRISC_INSN_MULIX,
 , OPENRISC_INSN_L_DIVIX
} CGEN_INSN_TYPE;
